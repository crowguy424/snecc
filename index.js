...
const pause = document.getElementById('press');
...
const initGame = () =>{
    ...
    if(snakeX === foodX && snakeY === foodY){
        ...
        score++;
        highScore = score >= highScore ? score : highScore; //if score > high score => score
...
pause.addEventListener('click', () =>{
    if(isPause){
        ...
        pause.textContent = 'this game works only for web';
        pause.disabled = true;
